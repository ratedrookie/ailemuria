    ...
    if (browserProvider?.isMetaMask !== true) {
      this.setError( 
        <>
          ...
          <br />
         You can interact with the smart-contract through <a href={this.generateContractUrl()} target="_blank">{this.state.networkConfig.blockExplorer.name}</a> and <strong>we do our best to provide you with the best user experience possible</strong>, even from there.<br />
          <br />
        ...
        {!this.isWalletConnected() || !this.isSoldOut() ?
          <div className="no-wallet">
            ...
            <div className="use-block-explorer">
              ...
              Interact with the smart-contract <strong>directly</strong> through <a href={this.generateContractUrl()} target="_blank">{this.state.networkConfig.blockExplorer.name}</a>, without even connecting your wallet to this DAPP.<br />
              <br />
